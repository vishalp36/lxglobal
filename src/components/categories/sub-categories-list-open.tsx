...
export default function SubCategoriesListOpen(props) {
  return (
    <>
      <section
        className={`${styles["sub-categories-list-section"]} open  ${styles.open}`}
      >
        <div className="container">
          ...
          <div className={`${styles["sub-category-border-bottom"]}`} />
        </div>
      </section>
    </>
  );

                            ...
                            <div className={`${styles['flex-container']}`}>
                                ...
                                <div className={`${styles['select-address']}`}>
                                    <Button className="btn-link btn-link-with-icon">
                                        ...
                                        <span className={`text-truncate ${styles['hide-in-mobile']} ${styles['max-w']}`}>Choose delivery address</span>
                                        <span className={`text-truncate ${styles['hide-in-desktop-769']} ${styles['max-w']}`}>Deliver to</span>
                                        <span className={`${styles['hide-in-desktop-only']}`}>
                                            <img src={DownArrow} alt="Delivery" className={`${styles['down-arrow']}`} />
                                        </span>
                                    </Button>
                                </div>
                                <div className={`${styles['right-section']}`}>
                                    ...
                                    <div>
                                        <Button element="a" href="/" className="btn-link btn-link-white">Sign in</Button>
                                    </div>
                                </div>
                            </div>
                        </div>

...
import OrderSummaryBox from "./order-summary-box-with-discount";
import DeliveryDetails from "./delivery-details/delivery-details-non-signed-in-info-added";
    ...
    <>
        ...
        <div className={`${styles['checkout-container']} container`}>
            ...
            <div className={`${styles['hide-in-desktop']}`}>
                <div className={`${styles['min-h-box-158']}`} />
                <div className={`${styles['fix-checkout-footer']}`}>
                    ...
                    <div className={`${styles['space-between']}`}>
                        <p className={`${styles['sm-text']} text-14 text-primary`}>
                            Discount
                        </p>
                        <p className={`${styles['sm-text']} text-14 text-primary`}>
                            -&euro;1.25

            ...
            <div className={`${styles['product-content-container']}`}>
                <div className={`${styles['product-top-section']}`}>
                    <div className={`${styles['product-image-section']} product-detail-slider`}>
                        ...
                        >
                            <SwiperSlide>
                                <div className={`${styles['product-image-box']} ${styles['out-of-stock']}`}>
                                    <img src={Product1} alt="Product" />
                                </div>
                                <span className={`${styles['not-available']}`}>Not available right now</span>
                            </SwiperSlide>
                            <SwiperSlide>
                                <div className={`${styles['product-image-box']} ${styles['out-of-stock']}`}>
                                    <img src={Product1} alt="Product" />
                    ...
                    <div className={`${styles['product-content-section']}`}>
                       <div>
                            ...
                            <div>
                                ...
                                />
                                <Button className="btn-block" disabled>Out of stock</Button>
                            </div>
